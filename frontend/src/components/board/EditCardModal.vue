...
import type { Card, Comment, Attachment, ActivityEntry } from '@/types/domain'
...
interface Emits {
  (e: 'close'): void
  (e: 'update', data: { title: string; description: string; assigneeId?: string }): void
  (e: 'delete'): void
}
...
// --- Load comments, attachments and activity on mount ---
onMounted(() => {
  loadComments()
  loadActivity()
  loadAttachments()
