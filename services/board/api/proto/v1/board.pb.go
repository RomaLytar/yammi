...
const file_api_proto_v1_board_proto_rawDesc = "" +
	...
	"\acolumns\x18\x01 \x03(\v2\x10.board.v1.ColumnR\acolumns\"\xd9\x01\n" +
	...
	"\n" +
	"card_count\x18\b \x01(\x05R\tcardCount\"\xf2\x02\n" +
	"\x04Card\x12\x0e\n" +
	...
	"\rGetCardLabels\x12\x1e.board.v1.GetCardLabelsRequest\x1a\x1f.board.v1.GetCardLabelsResponseB@Z>github.com/RomaLytar/yammi/services/board/api/proto/v1;boardpbb\x06proto3"
...
var file_api_proto_v1_board_proto_msgTypes = make([]protoimpl.MessageInfo, 71)
...
var file_api_proto_v1_board_proto_depIdxs = []int32{
	...
	70, // 20: board.v1.ActivityEntry.changes:type_name -> board.v1.ActivityEntry.ChangesEntry
	71, // 21: board.v1.ActivityEntry.created_at:type_name -> google.protobuf.Timestamp
	...
	71, // 27: board.v1.Board.created_at:type_name -> google.protobuf.Timestamp
	71, // 28: board.v1.Board.updated_at:type_name -> google.protobuf.Timestamp
	71, // 29: board.v1.Column.created_at:type_name -> google.protobuf.Timestamp
	71, // 30: board.v1.Column.updated_at:type_name -> google.protobuf.Timestamp
	71, // 31: board.v1.Card.created_at:type_name -> google.protobuf.Timestamp
	71, // 32: board.v1.Card.updated_at:type_name -> google.protobuf.Timestamp
	71, // 33: board.v1.BoardMember.joined_at:type_name -> google.protobuf.Timestamp
	71, // 34: board.v1.Attachment.created_at:type_name -> google.protobuf.Timestamp
	71, // 35: board.v1.Label.created_at:type_name -> google.protobuf.Timestamp
	58, // 36: board.v1.CreateLabelResponse.label:type_name -> board.v1.Label
	58, // 37: board.v1.ListLabelsResponse.labels:type_name -> board.v1.Label
	58, // 38: board.v1.UpdateLabelResponse.label:type_name -> board.v1.Label
	58, // 39: board.v1.GetCardLabelsResponse.labels:type_name -> board.v1.Label
	0,  // 40: board.v1.BoardService.CreateBoard:input_type -> board.v1.CreateBoardRequest
	2,  // 41: board.v1.BoardService.GetBoard:input_type -> board.v1.GetBoardRequest
	4,  // 42: board.v1.BoardService.ListBoards:input_type -> board.v1.ListBoardsRequest
	6,  // 43: board.v1.BoardService.UpdateBoard:input_type -> board.v1.UpdateBoardRequest
	8,  // 44: board.v1.BoardService.DeleteBoard:input_type -> board.v1.DeleteBoardRequest
	9,  // 45: board.v1.BoardService.AddColumn:input_type -> board.v1.AddColumnRequest
	11, // 46: board.v1.BoardService.GetColumns:input_type -> board.v1.GetColumnsRequest
	13, // 47: board.v1.BoardService.UpdateColumn:input_type -> board.v1.UpdateColumnRequest
	15, // 48: board.v1.BoardService.DeleteColumn:input_type -> board.v1.DeleteColumnRequest
	16, // 49: board.v1.BoardService.ReorderColumns:input_type -> board.v1.ReorderColumnsRequest
	19, // 50: board.v1.BoardService.CreateCard:input_type -> board.v1.CreateCardRequest
	21, // 51: board.v1.BoardService.GetCard:input_type -> board.v1.GetCardRequest
	23, // 52: board.v1.BoardService.GetCards:input_type -> board.v1.GetCardsRequest
	25, // 53: board.v1.BoardService.UpdateCard:input_type -> board.v1.UpdateCardRequest
	27, // 54: board.v1.BoardService.MoveCard:input_type -> board.v1.MoveCardRequest
	29, // 55: board.v1.BoardService.DeleteCard:input_type -> board.v1.DeleteCardRequest
	30, // 56: board.v1.BoardService.AssignCard:input_type -> board.v1.AssignCardRequest
	32, // 57: board.v1.BoardService.UnassignCard:input_type -> board.v1.UnassignCardRequest
	34, // 58: board.v1.BoardService.GetCardActivity:input_type -> board.v1.GetCardActivityRequest
	37, // 59: board.v1.BoardService.AddMember:input_type -> board.v1.AddMemberRequest
	39, // 60: board.v1.BoardService.RemoveMember:input_type -> board.v1.RemoveMemberRequest
	40, // 61: board.v1.BoardService.ListMembers:input_type -> board.v1.ListMembersRequest
	42, // 62: board.v1.BoardService.IsMember:input_type -> board.v1.IsMemberRequest
	44, // 63: board.v1.BoardService.CreateUploadURL:input_type -> board.v1.CreateUploadURLRequest
	46, // 64: board.v1.BoardService.ConfirmUpload:input_type -> board.v1.ConfirmUploadRequest
	48, // 65: board.v1.BoardService.GetDownloadURL:input_type -> board.v1.GetDownloadURLRequest
	50, // 66: board.v1.BoardService.ListAttachments:input_type -> board.v1.ListAttachmentsRequest
	52, // 67: board.v1.BoardService.DeleteAttachment:input_type -> board.v1.DeleteAttachmentRequest
	59, // 68: board.v1.BoardService.CreateLabel:input_type -> board.v1.CreateLabelRequest
	61, // 69: board.v1.BoardService.ListLabels:input_type -> board.v1.ListLabelsRequest
	63, // 70: board.v1.BoardService.UpdateLabel:input_type -> board.v1.UpdateLabelRequest
	65, // 71: board.v1.BoardService.DeleteLabel:input_type -> board.v1.DeleteLabelRequest
	66, // 72: board.v1.BoardService.AddLabelToCard:input_type -> board.v1.AddLabelToCardRequest
	67, // 73: board.v1.BoardService.RemoveLabelFromCard:input_type -> board.v1.RemoveLabelFromCardRequest
	68, // 74: board.v1.BoardService.GetCardLabels:input_type -> board.v1.GetCardLabelsRequest
	1,  // 75: board.v1.BoardService.CreateBoard:output_type -> board.v1.CreateBoardResponse
	3,  // 76: board.v1.BoardService.GetBoard:output_type -> board.v1.GetBoardResponse
	5,  // 77: board.v1.BoardService.ListBoards:output_type -> board.v1.ListBoardsResponse
	7,  // 78: board.v1.BoardService.UpdateBoard:output_type -> board.v1.UpdateBoardResponse
	72, // 79: board.v1.BoardService.DeleteBoard:output_type -> google.protobuf.Empty
	10, // 80: board.v1.BoardService.AddColumn:output_type -> board.v1.AddColumnResponse
	12, // 81: board.v1.BoardService.GetColumns:output_type -> board.v1.GetColumnsResponse
	14, // 82: board.v1.BoardService.UpdateColumn:output_type -> board.v1.UpdateColumnResponse
	72, // 83: board.v1.BoardService.DeleteColumn:output_type -> google.protobuf.Empty
	18, // 84: board.v1.BoardService.ReorderColumns:output_type -> board.v1.ReorderColumnsResponse
	20, // 85: board.v1.BoardService.CreateCard:output_type -> board.v1.CreateCardResponse
	22, // 86: board.v1.BoardService.GetCard:output_type -> board.v1.GetCardResponse
	24, // 87: board.v1.BoardService.GetCards:output_type -> board.v1.GetCardsResponse
	26, // 88: board.v1.BoardService.UpdateCard:output_type -> board.v1.UpdateCardResponse
	28, // 89: board.v1.BoardService.MoveCard:output_type -> board.v1.MoveCardResponse
	72, // 90: board.v1.BoardService.DeleteCard:output_type -> google.protobuf.Empty
	31, // 91: board.v1.BoardService.AssignCard:output_type -> board.v1.AssignCardResponse
	33, // 92: board.v1.BoardService.UnassignCard:output_type -> board.v1.UnassignCardResponse
	35, // 93: board.v1.BoardService.GetCardActivity:output_type -> board.v1.GetCardActivityResponse
	38, // 94: board.v1.BoardService.AddMember:output_type -> board.v1.AddMemberResponse
	72, // 95: board.v1.BoardService.RemoveMember:output_type -> google.protobuf.Empty
	41, // 96: board.v1.BoardService.ListMembers:output_type -> board.v1.ListMembersResponse
	43, // 97: board.v1.BoardService.IsMember:output_type -> board.v1.IsMemberResponse
	45, // 98: board.v1.BoardService.CreateUploadURL:output_type -> board.v1.CreateUploadURLResponse
	47, // 99: board.v1.BoardService.ConfirmUpload:output_type -> board.v1.ConfirmUploadResponse
	49, // 100: board.v1.BoardService.GetDownloadURL:output_type -> board.v1.GetDownloadURLResponse
	51, // 101: board.v1.BoardService.ListAttachments:output_type -> board.v1.ListAttachmentsResponse
	72, // 102: board.v1.BoardService.DeleteAttachment:output_type -> google.protobuf.Empty
	60, // 103: board.v1.BoardService.CreateLabel:output_type -> board.v1.CreateLabelResponse
	62, // 104: board.v1.BoardService.ListLabels:output_type -> board.v1.ListLabelsResponse
	64, // 105: board.v1.BoardService.UpdateLabel:output_type -> board.v1.UpdateLabelResponse
	72, // 106: board.v1.BoardService.DeleteLabel:output_type -> google.protobuf.Empty
	72, // 107: board.v1.BoardService.AddLabelToCard:output_type -> google.protobuf.Empty
	72, // 108: board.v1.BoardService.RemoveLabelFromCard:output_type -> google.protobuf.Empty
	69, // 109: board.v1.BoardService.GetCardLabels:output_type -> board.v1.GetCardLabelsResponse
